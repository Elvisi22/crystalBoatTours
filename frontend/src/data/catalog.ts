// Static copy of the catalog so the site renders fully on a static host
// (e.g. Netlify) with no backend. The NestJS API mirrors this data and is
// still used by the full-stack build for bookings / contact / newsletter.
